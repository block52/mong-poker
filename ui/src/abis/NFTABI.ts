export const nftabi = [
    {
        inputs: [
            ...
            { internalType: "string", name: "initContractURI", type: "string" },
    ...
    },
    {
        ...
        inputs: [
            { indexed: true, internalType: "address", name: "operator", type: "address" },
            { indexed: true, internalType: "uint256", name: "tokenId", type: "uint256" },
            { indexed: true, internalType: "uint256", name: "burnTokenId", type: "uint256" }
        ],
        name: "Blend",
        type: "event"
    },
    ...
    { inputs: [{ internalType: "uint256", name: "tokenId", type: "uint256" }], name: "burn", outputs: [], stateMutability: "nonpayable", type: "function" },
    {
        ...
        name: "checkProjectWhitelist",
        outputs: [
            { internalType: "uint256[]", name: "startTime", type: "uint256[]" },
            { internalType: "uint256[]", name: "limitPerAddress", type: "uint256[]" },
    ...
    },
    {
        inputs: [
            { internalType: "uint256", name: "projectId", type: "uint256" },
            { internalType: "uint256", name: "burnProjectId", type: "uint256" }
        ],
        name: "configBlend",
        outputs: [],
        stateMutability: "nonpayable",
    ...
    },
    {
        inputs: [
            { internalType: "uint256", name: "projectId", type: "uint256" },
            { internalType: "uint256", name: "perkProjectId", type: "uint256" },
            { internalType: "uint256", name: "costEach", type: "uint256" },
            { internalType: "uint256", name: "startTime", type: "uint256" },
            { internalType: "uint256", name: "limitPerTx", type: "uint256" },
            { internalType: "uint256", name: "limitPerAddress", type: "uint256" },
            { internalType: "uint256", name: "limitPerToken", type: "uint256" }
        ],
        name: "configPerk",
        outputs: [],
        stateMutability: "nonpayable",
    ...
    },
    {
        inputs: [
            { internalType: "uint256", name: "projectId", type: "uint256" },
            { internalType: "uint256", name: "outputProjectId", type: "uint256" },
            { internalType: "uint256", name: "quantity", type: "uint256" }
        ],
        name: "configUpgrade",
        outputs: [],
    ...
    },
    {
        inputs: [{ internalType: "uint256", name: "projectId", type: "uint256" }],
        name: "projectBlends",
        outputs: [{ internalType: "uint256", name: "burnProjectId", type: "uint256" }],
        stateMutability: "view",
        type: "function"
    },
    {
    ...
    {
        inputs: [{ internalType: "uint256", name: "projectId", type: "uint256" }],
        name: "projectUpgrades",
        outputs: [
            { internalType: "uint256", name: "outputProjectId", type: "uint256" },
            { internalType: "uint256", name: "inputQuantity", type: "uint256" }
        ],
        stateMutability: "view",
        type: "function"
    },
    ...
    {
        inputs: [{ internalType: "string", name: "initContractURI", type: "string" }],
        name: "setContractURI",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function"
    ...
    {
        inputs: [{ internalType: "address", name: "payoutAddress", type: "address" }],
    ...
    {
        inputs: [{ internalType: "uint256", name: "projectFee", type: "uint256" }],
        name: "setProjectFee",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function"
    ...
    {
        inputs: [{ internalType: "address", name: "proxyRegistryAddress", type: "address" }],
        name: "setProxy",
        outputs: [],
        stateMutability: "nonpayable",
        type: "function"
